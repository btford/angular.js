...
var KEYWORD_PRIORITY = {
  ...
  '.overview': 1,
  '.bootstrap': 2,
  '.bootstrap.auto_bootstrap': 1,
  '.bootstrap.manual_bootstrap': 2,
  '.mvc': 3,
  '.mvc.understanding_model': 1,
  '.mvc.understanding_controller': 2,
  '.mvc.understanding_view': 3,
  '.scopes': 4,
  '.scopes.understanding_scopes': 1,
  '.scopes.internals': 2,
  '.compiler': 5,
  '.templates': 6,
  '.services': 7,
...
var GUIDE_PRIORITY = [
  ...
  'templates.filters.creating_filters',
  'templates.filters',
  'templates.filters.using_filters',
  'templates',
